...
<div class="col-md-8 offset-md-2">
  <div class="card">
    <div class="card-header">Edit a new portfolio</div>
    <div class="card-body">
      <form action="{{ route('portfolio.update', ['id' => $portfolio->id]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="skill" class="form-control" value="{{ $portfolio->skill }}">
        </div>

        <div class="form-group">
          <label for="title">Address</label>
          <input type="text" name="address" class="form-control" value="{{ $portfolio->address }}">
        </div>

        <div class="form-group">
          <label for="title">Date</label>
          <input type="text" name="date" class="form-control" placeholder="YYYY/MM/DD" value="{{ $portfolio->date }}">
        </div>


        <div class="form-group">
          <label for="content">Content</label>
          <textarea name="detail" id="summernote" rows="20" class="form-control">{{ $portfolio->detail }}</textarea>
        </div>
